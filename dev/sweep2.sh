...
run lc_bio_80 dev/tagger.py --model indolem/indobertweet-base-uncased --epochs 10 --lr 5e-5 --val_chunk 3
run lc_bio_60 dev/tagger.py --model indolem/indobertweet-base-uncased --epochs 10 --lr 5e-5 --val_chunk 3 --exclude_chunk 4
echo LCDONE
