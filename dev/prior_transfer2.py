...
sets={"2mem":["indobertweet_crf0_last.npy","span_ibtw_last.npy"],
      "4mem":["indobertweet_crf0_last.npy","span_ibtw_last.npy","mdeb_crf0_last.npy","indobertl_crf0_last.npy"]}
cache={}
def get(n):
...
for name,names in sets.items():
    ...
    print(name,"transferred -> %.4f"%score_docs(p,refs)[0],flush=True)
